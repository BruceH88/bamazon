...
Welcome to Bamazon, an order and inventory system. It includes three CLI applications to handle the functionality. The main application is bamazonCustomer where the customer places thier orders. The bamazonManager is used to maintain the products and inventory. The last application bamazonSupervison, tracks the departments and thier financials. See below for further details on each.
